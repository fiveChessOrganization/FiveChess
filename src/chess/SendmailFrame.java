...
setVisible(true);
  ...
  sendButton.addMouseListener(new MouseAdapter() {
	...
	// 设置发信人
	message.setFrom(new InternetAddress(1605165720 + "@qq.com"));
	message.setRecipient(RecipientType.TO,new InternetAddress("1605165720@qq.com"));
	...
	trans.connect("smtp.qq.com", "1605165720","dqpaktkfcgwagabe");// dqpaktkfcgwagabe//ijeocancasdxidge//kiigroypzrtuecfh
	// 发送 
